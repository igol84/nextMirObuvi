      ...
      {lang === 'en' ? (
          <>
            <p>You can buy shoes from various manufacturers from us.<br/> Purchases will be delivered at a convenient time
              for you address indicated in the order.<br/>We will help you save both time and money - our prices are lower
              than those of ordinary stores.<br/> We hope that our store will prove to be a useful and economical helper
              in your implementation shopping
            </p>
            ...
            <p>The product can be ordered through the online store by specifying your contact information. <br/>Our
              managers the nearest sometimes will process the order and contact you.</p>
            ...
            <p>You have the right to inspect and measure the goods at the &apos;Nova Poshta&apos; branch. To do this,
              approach the employee and calls number of the goods and transport number, the employee checks the
              availability of the goods in the warehouse and takes them out of the zone composition, after this You pay
              the specified amount in advance (the value of the goods), you are issued a parcel, check (you can measure),
              if the product does not fit, &nbsp; then you notify the employee of &apos;Nova Poshta&apos; LLC about this.
              and receive money back. IN in this case, the goods are returned to the Sender.
            </p>
            <h3>Discounts</h3>
        ...
        : (
          <>
            <p>У нас Ви можете придбати взуття від різних виробників.<br/> Покупки доставлять у зручний для Вас час за
              адресою вказаною у замовленні.<br/>Ми допоможемо Вам заощадити і час та гроші - наші ціни нижчі, ніж у
              звичайних магазинах.<br/> Сподіваємося, що наш магазин виявиться Вам корисним та економічним помічником у
              здійсненні покупок.
            </p>
            ...
            <p>Товар можна замовити через інтернет-магазин, вказавши свою контактну інформацію. <br/>Наші менеджери
              найближчим часом опрацюють замовлення та зв`&apos;яжуться з Вами.</p>
            ...
            <p>У відділення &quot;Нова Пошта&quot; Ви маєте право оглянути та поміряти товар. Для цього підходите до
              співробітника і називає номер товарно-транспортної, співробітник перевіряє наявність товару на складі та
              виносить його із зони складу, після цього. Ви вносите авансом вказану суму (вартість товару), вам
              видається посилка, перевіряєте (можете поміряти), якщо товар не підходить, &nbsp; то ви сповіщаєте про це
              співробітника ТОВ &laquo;Нова Пошта&raquo; і отримуєте гроші назад. У такому випадку оформляється
              повернення товару Відправнику.
            </p>
            <h3>Скидки</h3>
